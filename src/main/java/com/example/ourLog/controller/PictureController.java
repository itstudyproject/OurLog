...
public class PictureController {
  ...
  public ResponseEntity<Long> registerJournal(@RequestBody PostDTO postDTO) {
  ...
  public ResponseEntity<Map<String, PostDTO>> getJournal(@PathVariable("postId") Long postId) {
